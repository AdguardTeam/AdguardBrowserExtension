export const LOCALES = ['en', 'ru', 'de', 'es', 'fr', 'ja', 'hu', 'pl', 'da', 'uk', 'ar', 'sv', 'fa', 'it', 'pt-BR', 'pt-PT', 'id', 'sk', 'tr', 'cs', 'nl', 'zh_CN', 'zh_TW', 'hr', 'sr-Latn', 'ms', 'vi', 'hy', 'ro', 'ko', 'bg', 'ca', 'sl', 'be', 'nb', 'bg-BG', 'el', 'fi', 'mk-MK', 'he'];
