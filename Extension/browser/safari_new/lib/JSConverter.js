...
}).call(this,cachedModules[5973],cachedModules[5973].exports);
cachedModules[331]={exports:{}};
...
var StringUtils = exports.StringUtils = {
	...
	};}).call(this,cachedModules[331],cachedModules[331].exports);
cachedModules[2323]={exports:{}};
(function(module,exports) {/*! http://mths.be/punycode v1.3.0 by @mathias */
	...
	}(this));}).call(this,cachedModules[2323],cachedModules[2323].exports);
cachedModules[558]={exports:{}};
(function(module,exports) {/**
 ...
 */
	 ...
	 */
	var StringUtils = cachedModules[331].exports.StringUtils;
	var punycode = cachedModules[2323].exports.punycode;
...
}).call(this,cachedModules[558],cachedModules[558].exports);
cachedModules[5169]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
...
}).call(this,cachedModules[5169],cachedModules[5169].exports);
cachedModules[4942]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
 ...
 */
	 ...
	 */
	var StringUtils = cachedModules[331].exports.StringUtils;
	var CollectionUtils = cachedModules[331].exports.CollectionUtils;
	var UrlUtils = cachedModules[558].exports.UrlUtils;
	var Log = cachedModules[5169].exports.Log;
...
}).call(this,cachedModules[4942],cachedModules[4942].exports);
cachedModules[1792]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
 ...
 */
	 ...
	 */
	var StringUtils = cachedModules[331].exports.StringUtils;
	var FilterRule = cachedModules[4942].exports.FilterRule;
...
}).call(this,cachedModules[1792],cachedModules[1792].exports);
cachedModules[6451]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
...
}).call(this,cachedModules[6451],cachedModules[6451].exports);
cachedModules[2220]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
 ...
 */
	...
	ScriptFilterRule.prototype = Object.create(FilterRule.prototype);}).call(this,cachedModules[2220],cachedModules[2220].exports);
cachedModules[6261]={exports:{}};
(function(module,exports) {var FilterRule = cachedModules[4942].exports.FilterRule;
	var StringUtils = cachedModules[331].exports.StringUtils;
	var Log = cachedModules[5169].exports.Log;

	var FilterClasses = exports.FilterClasses = {
		CssFilterRule: cachedModules[1792].exports.CssFilterRule,
		UrlFilterRule: cachedModules[6451].exports.UrlFilterRule,
		ScriptFilterRule: cachedModules[2220].exports.ScriptFilterRule
	}
	...
	FilterRule.createRule = function (ruleText) {
		...
		return rule;
	};}).call(this,cachedModules[6261],cachedModules[6261].exports);
cachedModules[3928]={exports:{}};
(function(module,exports) {/**
...
// Max number of CSS selectors per rule (look at _compactCssRules function)
	...
	var punycode = cachedModules[5973].exports;

	var FilterRule = cachedModules[4942].exports.FilterRule;
	var FilterClasses = cachedModules[6261].exports.FilterClasses;
	var CssFilterRule = cachedModules[1792].exports.CssFilterRule;
	var UrlFilterRule = cachedModules[6451].exports.UrlFilterRule;
	var ScriptFilterRule = cachedModules[2220].exports.ScriptFilterRule;
	var StringUtils = cachedModules[331].exports.StringUtils;
	var Log = cachedModules[5169].exports.Log;
	var UrlUtils = cachedModules[558].exports.UrlUtils;
...
}).call(this,cachedModules[3928],cachedModules[3928].exports);function jsonFromFilters(rules, limit){
	try {
		var SafariContentBlockerConverter = cachedModules[3928].exports.SafariContentBlockerConverter;
