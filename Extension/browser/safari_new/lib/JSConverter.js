...
}).call(this,cachedModules[5833],cachedModules[5833].exports);
cachedModules[9316]={exports:{}};
...
};}).call(this,cachedModules[9316],cachedModules[9316].exports);
cachedModules[4940]={exports:{}};
...
}(this));}).call(this,cachedModules[4940],cachedModules[4940].exports);
cachedModules[4635]={exports:{}};
(function(module,exports) {/**
 ...
 */
var StringUtils = cachedModules[9316].exports.StringUtils;
var punycode = cachedModules[4940].exports.punycode;
...
var UrlUtils = exports.UrlUtils = {
	...
	urlToPunyCode: function (url) {
		...
		for (i = 0; i < startsWith.length; i++) {
			...
			if (StringUtils.startWith(url, start)) {
		...
		return StringUtils.replaceAll(url, domain, UrlUtils.toPunyCode(domain));
	},

	isThirdPartyRequest: function (requestUrl, referrer) {
		var domainName = UrlUtils._get2NdLevelDomainName(requestUrl);
		var refDomainName = UrlUtils._get2NdLevelDomainName(referrer);
	...
	isDomainOrSubDomain: function (domainNameToCheck, domainName) {
		...
		return (domainName == domainNameToCheck ||
			(StringUtils.endWith(domainNameToCheck, domainName) &&
			StringUtils.endWith(domainNameToCheck, "." + domainName)));
	},
...
}).call(this,cachedModules[4635],cachedModules[4635].exports);
cachedModules[931]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
...
}).call(this,cachedModules[931],cachedModules[931].exports);
cachedModules[6776]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
 ...
 */
var StringUtils = cachedModules[9316].exports.StringUtils;
var CollectionUtils = cachedModules[9316].exports.CollectionUtils;
var UrlUtils = cachedModules[4635].exports.UrlUtils;
var Log = cachedModules[931].exports.Log;
...
}).call(this,cachedModules[6776],cachedModules[6776].exports);
cachedModules[332]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
 ...
 */
var StringUtils = cachedModules[9316].exports.StringUtils;
var FilterRule = cachedModules[6776].exports.FilterRule;
...
}).call(this,cachedModules[332],cachedModules[332].exports);
cachedModules[3612]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
...
}).call(this,cachedModules[3612],cachedModules[3612].exports);
cachedModules[4794]={exports:{}};
(function(module,exports) {/**
 * This file is part of Adguard Browser Extension (https://github.com/AdguardTeam/AdguardBrowserExtension).
 *
 * Adguard Browser Extension is free software: you can redistribute it and/or modify
...
ScriptFilterRule.prototype = Object.create(FilterRule.prototype);}).call(this,cachedModules[4794],cachedModules[4794].exports);
cachedModules[5807]={exports:{}};
(function(module,exports) {var FilterRule = cachedModules[6776].exports.FilterRule;
var StringUtils = cachedModules[9316].exports.StringUtils;
var Log = cachedModules[931].exports.Log;

var FilterClasses = exports.FilterClasses = {
    CssFilterRule: cachedModules[332].exports.CssFilterRule,
    UrlFilterRule: cachedModules[3612].exports.UrlFilterRule,
    ScriptFilterRule: cachedModules[4794].exports.ScriptFilterRule
}
...
FilterRule.createRule = function (ruleText) {
    ...
    try {
        ...
        var CssFilterRule = FilterClasses.CssFilterRule;
        var UrlFilterRule = FilterClasses.UrlFilterRule;
        var ScriptFilterRule = FilterClasses.ScriptFilterRule;
    ...
    return rule;
};}).call(this,cachedModules[5807],cachedModules[5807].exports);
cachedModules[4592]={exports:{}};
(function(module,exports) {/**
 * Safari content blocking format rules converter.
 */
var CONVERTER_VERSION = '1.1.2';
...
var punycode = cachedModules[5833].exports;

var FilterRule = cachedModules[6776].exports.FilterRule;
var FilterClasses = cachedModules[5807].exports.FilterClasses;
var CssFilterRule = cachedModules[332].exports.CssFilterRule;
var UrlFilterRule = cachedModules[3612].exports.UrlFilterRule;
var ScriptFilterRule = cachedModules[4794].exports.ScriptFilterRule;
var StringUtils = cachedModules[9316].exports.StringUtils;
var Log = cachedModules[931].exports.Log;
var UrlUtils = cachedModules[4635].exports.UrlUtils;
...
exports.SafariContentBlockerConverter = {
    ...
    AGRuleConverter: {
        ...
        _addResourceType: function (rule, result) {
            ...
            if (rule.permittedContentType & FilterClasses.UrlFilterRule.contentTypes.IMAGE)
                types.push("image");
            if (rule.permittedContentType & FilterClasses.UrlFilterRule.contentTypes.STYLESHEET)
                types.push("style-sheet");
            if (rule.permittedContentType & FilterClasses.UrlFilterRule.contentTypes.SCRIPT)
                types.push("script");
            if (rule.permittedContentType & FilterClasses.UrlFilterRule.contentTypes.MEDIA)
                types.push("media");
            if (rule.permittedContentType & FilterClasses.UrlFilterRule.contentTypes.POPUP)
                types.push("popup");
            if (rule.permittedContentType & (FilterClasses.UrlFilterRule.contentTypes.XMLHTTPREQUEST | FilterClasses.UrlFilterRule.contentTypes.OTHER))
                types.push("raw");
            if (rule.permittedContentType & FilterClasses.UrlFilterRule.contentTypes.FONT)
                types.push("font");

            //Use document for subdocument
            if (rule.permittedContentType == FilterClasses.UrlFilterRule.contentTypes.SUBDOCUMENT)
                types.push("document");

            //Not supported modificators
            if (rule.permittedContentType == FilterClasses.UrlFilterRule.contentTypes.OBJECT)
                throw new Error('Object content type is not yet supported');
            if (rule.permittedContentType == FilterClasses.UrlFilterRule.contentTypes.OBJECT_SUBREQUEST)
                throw new Error('Object_subrequest content type is not yet supported');
            if (rule.permittedContentType == (FilterClasses.UrlFilterRule.contentTypes.JSINJECT | FilterClasses.UrlFilterRule.contentTypes.ALL))
        ...
        _checkWhiteListExceptions: function (rule, result) {
            function isDocumentRule(r) {
                return r.permittedContentType == (FilterClasses.UrlFilterRule.contentTypes.DOCUMENT | FilterClasses.UrlFilterRule.contentTypes.ALL);
            }

            function isUrlBlockRule(r) {
                return r.permittedContentType == (FilterClasses.UrlFilterRule.contentTypes.URLBLOCK | FilterClasses.UrlFilterRule.contentTypes.ALL);
            }
...
}).call(this,cachedModules[4592],cachedModules[4592].exports);function jsonFromFilters(rules, limit){
    try {
        var SafariContentBlockerConverter = cachedModules[4592].exports.SafariContentBlockerConverter;
