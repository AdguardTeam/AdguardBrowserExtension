...
exports.SafariContentBlockerConverter = {
    ...
    convertLine: function (ruleText, errors) {
        ...
        try {
            ...
            if (agRule instanceof FilterClasses.CssFilterRule) {
                return this.AGRuleConverter.convertCssFilterRule(agRule);
            }

            if (agRule instanceof FilterClasses.ScriptFilterRule) {
                return this.AGRuleConverter.convertScriptRule(agRule);
            }

            if (agRule instanceof FilterClasses.UrlFilterRule) {
                return this.AGRuleConverter.convertUrlFilterRule(agRule);
            }

            throw new Error('Rule is not supported: ' + ruleText);
        } catch (ex) {
