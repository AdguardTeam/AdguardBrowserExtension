...
function testExtendedCssBuild() {
    ...
    assertEquals(commonCss.length, 1);
    assertEquals(css.length, 2);
    assertEquals(extendedCss.length, 1);
    ...
    assertTrue(injectRule.isInjectRule);
    assertFalse(injectRule.extendedCss);
    filter.addRule(injectRule);
    ...
    assertEquals(commonCss.length, 1);
    assertEquals(css.length, 1);
    assertEquals(extendedCss.length, 0);
    ...
    assertTrue(exceptionInjectRule.isInjectRule);
    assertFalse(exceptionInjectRule.extendedCss);
    assertTrue(exceptionInjectRule.whiteListRule);
...
addTestCase(testExtendedCssBuild);
