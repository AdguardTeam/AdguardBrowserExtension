...
export const createExceptionCssRule = (
    ...
    if (!rule || !rule.appliedRuleText) {
        logger.error(`[ext.RequestWizard.createExceptionCssRule]: cannot create css exception rule for an event with id: ${event.eventId} because rule is not defined or appliedRuleText is not defined.`);
        return '';
    }
    ...
    logger.error('[ext.ruleCreators.createExceptionCssRule]: cannot createExceptionCssRule for the rule:', rule);
...
export const createExceptionScriptRule = (
    ...
    if (!rule || !rule.appliedRuleText) {
        logger.error(`[ext.ruleCreators.createExceptionScriptRule]: cannot create exception blocking script rule for an event with id: ${event.eventId} because rule is not defined or appliedRuleText is not defined.`);
        return '';
    }
