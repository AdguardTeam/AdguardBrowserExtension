...
export const Icons = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
            ...
            <symbol id="popup-loading" viewBox="0 0 32 32">
                <path stroke="#67B279" fill="#67B279" d="M4.366 19.79c-.578.188-.898.811-.663 1.372a13.337 13.337 0 1 0 3.773-15.42c-.467.39-.471 1.09-.045 1.524.425.434 1.119.435 1.593.055a11.136 11.136 0 1 1-3.22 13.156c-.244-.557-.86-.876-1.438-.687Z" />
            </symbol>
        </svg>
    );
};
