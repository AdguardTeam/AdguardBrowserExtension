...
export const localScriptRules = {
    ...
    'document.cookie="show_share=true; path=/;";': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["9fa386e4a7f5a25377523a2c743da6d9"] === e) return;
            document.cookie = "show_share=true; path=/;";
    ...
    '(function(){var b=window.addEventListener;window.addEventListener=function(c,a,d){if(a&&-1==a.toString().indexOf("adblocker"))return b(c,a,d)}.bind(window)})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["3c94e62d04214a62e1bf1be209aed83b"] === e) return;
            !function() {
                var e = window.addEventListener;
                window.addEventListener = function(n, t, r) {
                    if (t && -1 == t.toString().indexOf("adblocker")) return e(n, t, r);
                }.bind(window);
            }();
    ...
    "(function(){var b=window.setInterval;window.setInterval=function(a,c){if(!/.\\.display=='hidden'[\\s\\S]*?.\\.visibility=='none'/.test(a.toString()))return b(a,c)}.bind(window)})();": () => {
        try {
            const e = "done";
            if (Window.prototype.toString["2610380c7215f8ed3dab7859b677c07e"] === e) return;
            !function() {
    ...
    "window.cRAds = !0;": () => {
        try {
            const e = "done";
            if (Window.prototype.toString["05f59c5992059f458f16aa93e814a859"] === e) return;
            window.cRAds = !0;
    ...
    "window.spoof_weer2edasfgeefzc = true;": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.f383cd371dd44d7f9a6f53a66c468020 === e) return;
    ...
    "window.adblock = 'no';": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.c6ea598841fd47b4e64cb41f4a71cde9 === e) return;
            window.adblock = "no";
    ...
    "window.check_adblock = true;": () => {
        try {
            const e = "done";
            if (Window.prototype.toString["8703d7f8d98d46a5463db89eea32ce11"] === e) return;
    ...
    "window.popns = true;": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.d03453914a0f0c39d24075d7778082b7 === e) return;
            window.popns = !0;
    ...
    "var _st = window.setTimeout; window.setTimeout = function(a, b) { if(!/isAdsBlocked/.test(a)){ _st(a,b);}};": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.af81ff1359da9b5444bcb191794ca25d === e) return;
            var _st = window.setTimeout;
            window.setTimeout = function(e, t) {
    ...
    "(function(){window.setTimeout=new Proxy(window.setTimeout,{apply:(a,b,c)=>c&&c[0]&&/if\\(!/.test(c[0].toString())&&c[1]&&1e4===c[1]?(c[1]*=.01,Reflect.apply(a,b,c)):Reflect.apply(a,b,c)});window.setInterval=new Proxy(window.setInterval,{apply:(a,b,c)=>c&&c[0]&&/initWait/.test(c[0].toString())&&c[1]&&1e3===c[1]?(c[1]*=.01,Reflect.apply(a,b,c)):Reflect.apply(a,b,c)})})();": () => {
        try {
            const e = "done";
            if (Window.prototype.toString["651f882509e2b8548706a310152c5126"] === e) return;
            !function() {
                window.setTimeout = new Proxy(window.setTimeout, {
    ...
    '(function(){var a;Object.defineProperty(window,"initLbjs",{get:function(){return a},set:function(c){a=function(a,b){b.AdPop=!1;return c(a,b)}}})})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["7872a331bbac5d34b400cc3369c46738"] === e) return;
            !function() {
                var e;
    ...
    '(function(){var d=(new URL(window.location.href)).searchParams.get("cr");try{var a=atob(d)}catch(b){}try{new URL(a);var c=!0}catch(b){c=!1}if(c)try{window.location=a}catch(b){}})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString.c1d6890e971fdba258e3692075d82479 === e) return;
            !function() {
    ...
    '!function(){var b=0,d=[];new MutationObserver(function(){document.querySelectorAll("div[data-pagelet^=\\"FeedUnit\\"]:not([style*=\\"display: none\\"]), div[role=\\"feed\\"] > div:not([style*=\\"display: none\\"]), div[role=\\"feed\\"] > span:not([style*=\\"display: none\\"]), #ssrb_feed_start + div > div[class]:not([style*=\\"display: none\\"]), #ssrb_feed_start + div span > h3 ~ div[class]:not([style*=\\"display: none\\"]), #ssrb_feed_start + div h3~ div[class]:not([style*=\\"display: none\\"]), #ssrb_feed_start + div h3 ~ div > div[class]:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div[class] > #ssrb_feed_start ~ div > h3 ~ div > div[class]:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > h3 ~ div > div[class]:not([style*=\\"display: none\\"]), #ssrb_feed_start + div > div > div[class]:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > h2 ~ div > div[class]:not([style*=\\"display: none\\"]), #ssrb_feed_start + div > div > div[class] > div:not([class], [id]) div:not([class], [id]):not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > h3 ~ div > div[class] > div:not([class], [id]) div:not([class], [id], [dir], [data-0], [style]), div[role=\\"main\\"] div > h2 ~ div > div[class] > div > div:not([style*=\\"display: none\\"]), div[role=\\"main\\"] h3[dir=\\"auto\\"] + div > div[class]:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > h2 ~ div > div[class] > div > div:not([style*=\\"display: none\\"]) > div:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > h2 ~ div > div > div > div:not([style*=\\"display: none\\"]) > div:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > h3 ~ div > div > div > div:not([style*=\\"display: none\\"]) > div:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > :is(h2, h3) ~ div > * div[class] > div > div:not([style*=\\"display: none\\"]), div[role=\\"main\\"] div > :is(h2, h3) ~ div > * > div > div[class]:not([style*=\\"display: none\\"])").forEach(function(e){Object.keys(e).forEach(function(a){if(a.includes?.("__reactEvents")||a.includes?.("__reactProps")){a=e[a];try{if(a.children?.props?.category?.includes("SPONSORED")||a.children?.props?.children?.props?.category?.includes("SPONSORED")||a.children?.props?.feedEdge?.category?.includes("SPONSORED")||a.children?.props?.children?.props?.feedEdge?.category?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.feedEdge?.category?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.category?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.feed_story_category?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.story_category?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.story_cat?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.category_sensitive?.cat?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.node?.sponsored_data?.brs_filter_setting||a.children?.props?.children?.props?.children?.props?.children?.props?.feedUnit?.lbl_sp_data?.ad_id||a.children?.props?.children?.props?.minGapType?.includes("SPONSORED")||a.children?.props?.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.node?.sponsored_data?.brs_filter_setting||a.children?.props?.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.node?.spons_data?.brs_filter_setting||a.children?.props?.children?.props?.feedEdge?.cat_sensitive?.cat?.includes("SPONSORED")||a.children?.props?.children?.props?.feedEdge?.node?.sponso_dat_flag?.brs_filter_setting||a.children?.props?.children?.props?.children?.props?.children?.props?.children?.props?.feedEdge?.node?.sponso_dat_flag?.brs_filter_setting){b++,e.style="display: none !important;";var f=e.querySelector("a[href][aria-label]:not([aria-hidden])");f&&(d.push(["Ad blocked based on property ["+b+"] -> "+f.ariaLabel]),console.table(d))}}catch(a){}}})})}).observe(document,{childList:!0,subtree:!0})}();': () => {
        try {
            ...
            Object.defineProperty(Window.prototype.toString, "c4dd9ebbc00e15dee2fcd0fda123d227", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "c4dd9ebbc00e15dee2fcd0fda123d227" due to: ' + e);
        }
    },
    ...
    "(function(){var b=window.setTimeout;window.setTimeout=function(a,c){if(!/=setTimeout\\(/.test(a.toString()))return b(a,c)};})();": () => {
        try {
            const e = "done";
            if (Window.prototype.toString["0ced54e08131ded625d8ea5a23188494"] === e) return;
            !function() {
                var e = window.setTimeout;
                window.setTimeout = function(t, o) {
    ...
    '(function(){var c=document.addEventListener;document.addEventListener=function(a,b,d,e){"click"!=a&&-1==b.toString().indexOf(\'"dtnoppu"\')&&c(a,b,d,e)}.bind(document);})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["151b026ff6ad3e430ea55419ab72ee6d"] === e) return;
            !function() {
                var e = document.addEventListener;
                document.addEventListener = function(t, n, o, r) {
                    "click" != t && -1 == n.toString().indexOf('"dtnoppu"') && e(t, n, o, r);
                }.bind(document);
            }();
    ...
    '(function(){if(location.href.includes("/aHR0c"))try{let a=location.href.substring(location.href.indexOf("aHR0c"));a=atob(a),location.assign(decodeURIComponent(a))}catch(a){}})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["456ba5931d5112b0319da728f07d150b"] === e) return;
            !function() {
            ...
            console.error('Error executing AG js rule with uniqueId "456ba5931d5112b0319da728f07d150b" due to: ' + e);
        }
    },
    '(()=>{if(location.href.includes("?s=http")){const a=location.href.split("?s=").slice(1);try{location.assign(a)}catch(a){}}})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString.c577d251fe722ea90d3bb1001c6c6e11 === e) return;
            (() => {
    ...
    "(function(){var c=window.setTimeout;window.setTimeout=function(f,g){return g===1e3&&/TheLink/.test(f.toString())&&(g*=0.01),c.apply(this,arguments)}.bind(window)})();": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.a3a19d6d5950cc6759710e4021c08a41 === e) return;
            !function() {
                var e = window.setTimeout;
                window.setTimeout = function(t, o) {
    ...
    '(function() { window.Ya = window.Ya || {}; window.Ya.Metrika = function() { var a = function() {}; this.replacePhones = this.reachGoal = this.params = this.notBounce = this.hit = this.file = this.extLink = clickmap = trackLinks = this.addFileExtension = a }; var a = [], c = a.push; a.push = function(b) { a._init || "function" !== typeof b || (b(), a._init = !0); c.call(a, b) }; window.yandex_metrika_callbacks = a})();': () => {
        try {
            const i = "done";
            if (Window.prototype.toString.a56796f47f0de963d8c564579e5148aa === i) return;
            !function() {
                window.Ya = window.Ya || {};
    ...
    '(function(){if(-1<window.location.href.indexOf("/#")){var a=location.href.split("/#");if(a&&a[1]){a=a[1];for(var c=0;10>c;c++)try{a=atob(a)}catch(f){var d=a.replace(/[a-zA-Z]/g,function(b){return String.fromCharCode(("Z">=b?90:122)>=(b=b.charCodeAt(0)+13)?b:b-26)});try{new URL(d);var e=!0}catch(b){e=!1}if(e){window.location=d;break}}}}})();': () => {
        try {
            const r = "done";
            if (Window.prototype.toString["3937ca8d5dd840aca311dfd69741ce6c"] === r) return;
            !function() {
                if (-1 < window.location.href.indexOf("/#")) {
