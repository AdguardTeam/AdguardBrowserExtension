        ...
        try {
            ...
            (() => {
                const e = /html-load\.com|loader\.min\.js|andwonderful\.com\/safe\.min\.js|shieldload\.|:\/\/loader\./, t = {
                    ...
                    construct: (e, n, c) => {
                        const l = o();
                        return r(l) && n[0] && t.includes.call(n[0], "adshield") && (n[0] = [ "(function(){})();" ]), 
                        Reflect.construct(e, n, c);
                    }
                };
                ...
                const c = {
                    apply: (e, n, c) => {
                        const l = o();
                        return r(l) && c[0] && t.includes.call(c[0], "new Error") && (c[0] = () => {}), 
                        Reflect.apply(e, n, c);
                    }
                };
                ...
                const l = {
                    apply: (e, n, c) => {
                        const l = o();
                        return r(l) && c[0] && n?.includes?.("setTimeout") && (n = t.filter.call(n, (e => !t.includes.call(e, "setTimeout")))), 
                        Reflect.apply(e, n, c);
                    }
                };
                window.Array.prototype.filter = new Proxy(window.Array.prototype.filter, l);
            })();
            Object.defineProperty(Window.prototype.toString, "58dccb168b1194b3f55775fa6079c05b", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "58dccb168b1194b3f55775fa6079c05b" due to: ' + e);
        }
    },
