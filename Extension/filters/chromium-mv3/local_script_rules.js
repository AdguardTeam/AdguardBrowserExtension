...
export const localScriptRules = {
    ...
    '(()=>{const e={apply:(e,r,t)=>{try{const a=t[0];if(!a?.context?.client)return Reflect.apply(e,r,t);a.context.client.clientScreen="ADUNIT",a.playbackContext&&(a.params=`yAEB${a.params?a.params:""}`),a.playerRequest&&(a.playerRequest.params=`yAEB${a.playerRequest.params?a.playerRequest.params:""}`),t[0]=a}catch(e){console.trace("Error occurred:",e)}return Reflect.apply(e,r,t)}};window.JSON.stringify=new Proxy(window.JSON.stringify,e)})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["39725944637501f3fb54e4221580118e"] === e) return;
            (() => {
                const e = {
                    apply: (e, r, t) => {
                        try {
                            const n = t[0];
                            if (!n?.context?.client) return Reflect.apply(e, r, t);
                            n.context.client.clientScreen = "ADUNIT", n.playbackContext && (n.params = `yAEB${n.params ? n.params : ""}`), 
                            n.playerRequest && (n.playerRequest.params = `yAEB${n.playerRequest.params ? n.playerRequest.params : ""}`), 
                            t[0] = n;
                        } catch (e) {
                            console.trace("Error occurred:", e);
                        }
            ...
            Object.defineProperty(Window.prototype.toString, "39725944637501f3fb54e4221580118e", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "39725944637501f3fb54e4221580118e" due to: ' + e);
        }
    },
    ...
    '(()=>{const e={apply:(e,t,n)=>{try{let c=n[0];if(!c)return Reflect.apply(e,t,n);const r=Array.isArray(c),a=r?c[0]:c;if((a.includes(\'"contentPlaybackContext"\')||a.includes(\'"adSignalsInfo"\'))&&(!a.includes(\'"params":"yAEB\')||!a.includes(\'"clientScreen":"ADUNIT"\'))){const c=JSON.parse(a);if(!c.context?.client)return Reflect.apply(e,t,n);c.context.client.clientScreen="ADUNIT",c.playbackContext&&(c.params=`yAEB${c.params?c.params:""}`);const o=JSON.stringify(c);r?n[0][0]=o:n[0]=o}}catch(e){console.trace("Error occurred:",e)}return Reflect.apply(e,t,n)}};window.XMLHttpRequest.prototype.send=new Proxy(window.XMLHttpRequest.prototype.send,e)})();': () => {
        try {
                ...
                const e = {
                    apply: (e, t, r) => {
                        try {
                            ...
                            if ((o.includes('"contentPlaybackContext"') || o.includes('"adSignalsInfo"')) && (!o.includes('"params":"yAEB') || !o.includes('"clientScreen":"ADUNIT"'))) {
            ...
            Object.defineProperty(Window.prototype.toString, "78d72494ea8bcdc16d5f0b415b6d466c", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
