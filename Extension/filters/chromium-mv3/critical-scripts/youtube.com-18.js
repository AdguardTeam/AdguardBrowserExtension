...
try {
    const t = "done";
    if (Window.prototype.toString["9c6c2461437a222172a5c932664b31f7"] === t) return;
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
        args: [ "ytd-consent-bump-v2-lightbox .eom-buttons > .ytd-consent-bump-v2-lightbox > .ytd-consent-bump-v2-lightbox button.ytSpecButtonShapeNextHost" ],
        engine: "extension",
        version: "2.4.2",
        verbose: !1
    } ].concat([ "ytd-consent-bump-v2-lightbox .eom-buttons > .ytd-consent-bump-v2-lightbox > .ytd-consent-bump-v2-lightbox button.ytSpecButtonShapeNextHost" ]));
    Object.defineProperty(Window.prototype.toString, "9c6c2461437a222172a5c932664b31f7", {
        value: t,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "9c6c2461437a222172a5c932664b31f7" due to: ' + t);
}
try {
    const t = "done";
    if (Window.prototype.toString["1fd12adcfadeb42f00feaf2bebc382da"] === t) return;
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
        args: [ "ytd-consent-bump-v2-lightbox .eom-buttons > .ytd-consent-bump-v2-lightbox > .ytd-consent-bump-v2-lightbox button.yt-spec-button-shape-next" ],
        engine: "extension",
        version: "2.4.2",
        verbose: !1
    } ].concat([ "ytd-consent-bump-v2-lightbox .eom-buttons > .ytd-consent-bump-v2-lightbox > .ytd-consent-bump-v2-lightbox button.yt-spec-button-shape-next" ]));
    Object.defineProperty(Window.prototype.toString, "1fd12adcfadeb42f00feaf2bebc382da", {
        value: t,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "1fd12adcfadeb42f00feaf2bebc382da" due to: ' + t);
}
try {
    const e = "done";
    if (Window.prototype.toString["816a72664579ac18edb5f14c3ed582f6"] === e) return;
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
        args: [ "ytm-consent-bump-v2-renderer .dialog-scrollable-content > .one-col-dialog-buttons > ytm-button-renderer.eom-reject button.ytSpecButtonShapeNextHost", "", "2000" ],
        engine: "extension",
        version: "2.4.2",
        verbose: !1
    } ].concat([ "ytm-consent-bump-v2-renderer .dialog-scrollable-content > .one-col-dialog-buttons > ytm-button-renderer.eom-reject button.ytSpecButtonShapeNextHost", "", "2000" ]));
    Object.defineProperty(Window.prototype.toString, "816a72664579ac18edb5f14c3ed582f6", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "816a72664579ac18edb5f14c3ed582f6" due to: ' + e);
}
try {
    const e = "done";
    if (Window.prototype.toString["471c2de3f48a70706f985258fee1802e"] === e) return;
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
        args: [ "ytm-consent-bump-v2-renderer .dialog-scrollable-content > .one-col-dialog-buttons > ytm-button-renderer.eom-reject button.yt-spec-button-shape-next", "", "2000" ],
        engine: "extension",
        version: "2.4.2",
        verbose: !1
    } ].concat([ "ytm-consent-bump-v2-renderer .dialog-scrollable-content > .one-col-dialog-buttons > ytm-button-renderer.eom-reject button.yt-spec-button-shape-next", "", "2000" ]));
    Object.defineProperty(Window.prototype.toString, "471c2de3f48a70706f985258fee1802e", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "471c2de3f48a70706f985258fee1802e" due to: ' + e);
}
try {
    const e = "done";
    if (Window.prototype.toString["643b2d3f6e8b7a8f66b636c7e7d25276"] === e) return;
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
        args: [ 'form[action="https://consent.youtube.com/save"][jsaction] button[jsname="b3VHJd"]' ],
        engine: "extension",
        version: "2.4.2",
        verbose: !1
    } ].concat([ 'form[action="https://consent.youtube.com/save"][jsaction] button[jsname="b3VHJd"]' ]));
    Object.defineProperty(Window.prototype.toString, "643b2d3f6e8b7a8f66b636c7e7d25276", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "643b2d3f6e8b7a8f66b636c7e7d25276" due to: ' + e);
}
})();
