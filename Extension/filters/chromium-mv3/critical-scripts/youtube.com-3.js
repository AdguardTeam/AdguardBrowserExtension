...
try {
    const e = "done";
    if (Window.prototype.toString.b644b79fadb30c57821cf8e3669c00de === e) return;
    ...
    Object.defineProperty(Window.prototype.toString, "b644b79fadb30c57821cf8e3669c00de", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "b644b79fadb30c57821cf8e3669c00de" due to: ' + e);
}
try {
    const e = "done";
    if (Window.prototype.toString["29e07e10c4883055d7d8ca248ab298b3"] === e) return;
    setConstant.apply(this, [ {
        name: "set-constant",
    ...
    Object.defineProperty(Window.prototype.toString, "29e07e10c4883055d7d8ca248ab298b3", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "29e07e10c4883055d7d8ca248ab298b3" due to: ' + e);
}
function noTopics(e, t) {
    var n = "done", o = e.uniqueId + e.name + "_" + (Array.isArray(t) ? t.join("_") : "");
    if (!e.uniqueId || Window.prototype.toString[o] !== n) {
        var r = t ? [].concat(e).concat(t) : [ e ];
        try {
            (function(e) {
                var t = "browsingTopics";
                if (Document instanceof Object != 0 && Object.prototype.hasOwnProperty.call(Document.prototype, t) && Document.prototype[t] instanceof Function != 0) {
                    Document.prototype[t] = function() {
                        return function() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "{}", t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "basic";
                            if ("undefined" != typeof Response) {
                                ...
                                return "opaque" === n ? Object.defineProperties(o, {
                                    body: {
                                        value: null
                                    },
                                    status: {
...
try {
    const e = "done";
    if (Window.prototype.toString["7e22a411dfbbe83bfc13ba426c901062"] === e) return;
    noTopics.apply(this, [ {
        name: "no-topics",
        args: [],
        engine: "extension",
    ...
    Object.defineProperty(Window.prototype.toString, "7e22a411dfbbe83bfc13ba426c901062", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "7e22a411dfbbe83bfc13ba426c901062" due to: ' + e);
}
function noProtectedAudience(e, n) {
    var o = "done", t = e.uniqueId + e.name + "_" + (Array.isArray(n) ? n.join("_") : "");
    if (!e.uniqueId || Window.prototype.toString[t] !== o) {
            ...
            (function(e) {
                if (Document instanceof Object != 0) {
                    for (var n = {
                        ...
                        var r = t[o], d = Navigator.prototype;
                        Object.prototype.hasOwnProperty.call(d, r) && d[r] instanceof Function != 0 && (d[r] = n[r]);
                    }
                    !function(e) {
                        if (e.verbose) {
                            try {
...
try {
    const e = "done";
    if (Window.prototype.toString["9cc11451c157c4b8aa0e5573c1fa672b"] === e) return;
    ...
    Object.defineProperty(Window.prototype.toString, "9cc11451c157c4b8aa0e5573c1fa672b", {
        value: e,
        enumerable: !1,
        writable: !1,
        configurable: !1
    ...
    console.error('Error executing AG js rule with uniqueId "9cc11451c157c4b8aa0e5573c1fa672b" due to: ' + e);
}
})();
