...
export const localScriptRules = {
    ...
    '(()=>{window.addEventListener("load",(()=>{const t=document.querySelector("#openwebSection"),e=document.querySelector("div[data-spot-id]");if(!e||!t)return;const d=e.getAttribute("data-spot-id");if(!d)return;((t,e)=>{const d=document.createElement("div");d.setAttribute("data-spotim-module","conversation"),d.setAttribute("data-spot-id",t),e.appendChild(d)})(d,t);const n=document.createElement("script");n.setAttribute("src",`https://launcher.spot.im/spot/${d}`),n.setAttribute("async",""),document.head.appendChild(n)}));})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["072e79443e63150cb42eef14b964d7fa"] === e) return;
            window.addEventListener("load", (() => {
                const e = document.querySelector("#openwebSection"), t = document.querySelector("div[data-spot-id]");
                if (!t || !e) return;
                const o = t.getAttribute("data-spot-id");
                if (!o) return;
                ((e, t) => {
                    const o = document.createElement("div");
                    o.setAttribute("data-spotim-module", "conversation"), o.setAttribute("data-spot-id", e), 
                    t.appendChild(o);
                })(o, e);
                const r = document.createElement("script");
                r.setAttribute("src", `https://launcher.spot.im/spot/${o}`), r.setAttribute("async", ""), 
                document.head.appendChild(r);
            }));
            Object.defineProperty(Window.prototype.toString, "072e79443e63150cb42eef14b964d7fa", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "072e79443e63150cb42eef14b964d7fa" due to: ' + e);
        }
    },
    ...
    '(()=>{const e="pyv",t="ad_type",n="none";let a=e;const o=e=>{a=e};(()=>{try{const e=Object.getOwnPropertyDescriptor(window.JSON,"parse");return!!e&&e.writable}catch(e){return!1}})()||((()=>{const e={apply:(e,t,n)=>{try{const e=t;e?.includes(\'"minimumPlaybackRate":100,"maximumPlaybackRate":100\')&&(t=e.replace(\'"minimumPlaybackRate":100,"maximumPlaybackRate":100\',\'"minimumPlaybackRate":25,"maximumPlaybackRate":200\'))}catch(e){}return Reflect.apply(e,t,n)}};window.String.prototype.replace=new Proxy(window.String.prototype.replace,e)})(),o(t));const c=e=>{(e.playbackContext||e.playerRequest)&&delete e.context?.client?.configInfo?.appInstallData},r=(a,o,r)=>{try{if(!a||!o||!r)return;if(r===e)return o.adPlaybackContext={pyv:!0},void c(a);if(r===t)return o.adPlaybackContext={adType:"AD_TYPE_INSTREAM"},void c(a);if(r===n)return void delete o.adPlaybackContext}catch(e){}},l=["playerErrorMessageRenderer","UNPLAYABLE"],i={apply:(c,r,i)=>{if(location.href.includes("/shorts/")||location.href.includes("youtube.com/tv")||location.href.includes("youtube.com/embed/")||a===n)return Reflect.apply(c,r,i);let y;try{if(y=Reflect.apply(c,r,i),!y.responseContext&&!y.playabilityStatus)return y;const u=JSON.stringify(y);return l.some((e=>u.includes(e)))&&!u.includes("CONTENT_CHECK_REQUIRED")?a===e?(o(t),y):(o(n),y):(a===t&&y.playerConfig?.granularVariableSpeedConfig&&(y.playerConfig.granularVariableSpeedConfig.maximumPlaybackRate=200,y.playerConfig.granularVariableSpeedConfig.minimumPlaybackRate=25),y)}catch(e){}return y}};window.JSON.parse=new Proxy(window.JSON.parse,i);const y={apply:(e,t,n)=>{if(location.href.includes("/shorts/")||location.href.includes("youtube.com/tv")||location.href.includes("youtube.com/embed/"))return Reflect.apply(e,t,n);try{let o=n[0];if(o&&(o.includes(\'"contentPlaybackContext"\')||o.includes(\'"adSignalsInfo"\'))){const c=JSON.parse(o);if(!c.context?.client)return Reflect.apply(e,t,n);c.playbackContext&&r(c,c.playbackContext,a),c.playerRequest&&r(c,c.playerRequest.playbackContext,a),o=JSON.stringify(c),n[0]=o}}catch(e){}return Reflect.apply(e,t,n)}};window.TextEncoder.prototype.encode=new Proxy(window.TextEncoder.prototype.encode,y);const u={apply:(e,t,n)=>{if(location.href.includes("/shorts/")||location.href.includes("youtube.com/tv")||location.href.includes("youtube.com/embed/"))return Reflect.apply(e,t,n);try{const o=n[0];if(!o?.context?.client)return Reflect.apply(e,t,n);o.playbackContext&&"undefined"===o.playbackContext.adPlaybackContext&&r(o,o.playbackContext,a),o.playerRequest&&"undefined"===o.playerRequest.playbackContext.adPlaybackContext&&r(o,o.playerRequest.playbackContext,a),n[0]=o}catch(e){}return Reflect.apply(e,t,n)}};window.JSON.stringify=new Proxy(window.JSON.stringify,u);const p={construct:(e,t,n)=>{try{const o=t[0];let c=t[1]?.body;if(!o?.includes("youtubei")||location.href.includes("/shorts/")||location.href.includes("youtube.com/tv")||location.href.includes("youtube.com/embed/")||!c)return Reflect.construct(e,t,n);if(c.includes(\'"contentPlaybackContext"\')||c.includes(\'"adSignalsInfo"\')){const o=JSON.parse(c);if(!o.context?.client)return Reflect.construct(e,t,n);o.playbackContext&&r(o,o.playbackContext,a),o.playerRequest&&r(o,o.playerRequest.playbackContext,a),c=JSON.stringify(o),t[1].body=c}}catch(e){}return Reflect.construct(e,t,n)}};window.Request=new Proxy(window.Request,p)})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString["1c271347300f532347107184abeafda3"] === e) return;
            (() => {
                ...
                const c = e => {
                    ...
                    try {
                        if (!a || !o || !r) return;
                        if (r === e) return o.adPlaybackContext = {
                            pyv: !0
                        }, void c(a);
                        if (r === t) return o.adPlaybackContext = {
                            adType: "AD_TYPE_INSTREAM"
                        }, void c(a);
                        if (r === n) return void delete o.adPlaybackContext;
                    } catch (e) {}
                }, l = [ "playerErrorMessageRenderer", "UNPLAYABLE" ], i = {
                    apply: (c, r, i) => {
                        if (location.href.includes("/shorts/") || location.href.includes("youtube.com/tv") || location.href.includes("youtube.com/embed/") || a === n) return Reflect.apply(c, r, i);
                        let u;
                        try {
                            if (u = Reflect.apply(c, r, i), !u.responseContext && !u.playabilityStatus) return u;
                            const y = JSON.stringify(u);
                            return l.some((e => y.includes(e))) && !y.includes("CONTENT_CHECK_REQUIRED") ? a === e ? (o(t), 
                            u) : (o(n), u) : (a === t && u.playerConfig?.granularVariableSpeedConfig && (u.playerConfig.granularVariableSpeedConfig.maximumPlaybackRate = 200, 
                            u.playerConfig.granularVariableSpeedConfig.minimumPlaybackRate = 25), u);
                        } catch (e) {}
                        return u;
                    }
                };
                window.JSON.parse = new Proxy(window.JSON.parse, i);
                const u = {
                    apply: (e, t, n) => {
                        ...
                        try {
                            let o = n[0];
                            if (o && (o.includes('"contentPlaybackContext"') || o.includes('"adSignalsInfo"'))) {
                                const c = JSON.parse(o);
                                if (!c.context?.client) return Reflect.apply(e, t, n);
                                c.playbackContext && r(c, c.playbackContext, a), c.playerRequest && r(c, c.playerRequest.playbackContext, a), 
                                o = JSON.stringify(c), n[0] = o;
                            }
                        } catch (e) {}
                        return Reflect.apply(e, t, n);
                    }
                ...
                const y = {
                    apply: (e, t, n) => {
                        ...
                        try {
                            ...
                            o.playbackContext && "undefined" === o.playbackContext.adPlaybackContext && r(o, o.playbackContext, a), 
                            o.playerRequest && "undefined" === o.playerRequest.playbackContext.adPlaybackContext && r(o, o.playerRequest.playbackContext, a), 
                            n[0] = o;
                        } catch (e) {}
                        return Reflect.apply(e, t, n);
                    }
                };
                window.JSON.stringify = new Proxy(window.JSON.stringify, y);
                const p = {
                    construct: (e, t, n) => {
                        try {
                            const o = t[0];
                            let c = t[1]?.body;
                            if (!o?.includes("youtubei") || location.href.includes("/shorts/") || location.href.includes("youtube.com/tv") || location.href.includes("youtube.com/embed/") || !c) return Reflect.construct(e, t, n);
                            if (c.includes('"contentPlaybackContext"') || c.includes('"adSignalsInfo"')) {
                                const o = JSON.parse(c);
                                if (!o.context?.client) return Reflect.construct(e, t, n);
                                o.playbackContext && r(o, o.playbackContext, a), o.playerRequest && r(o, o.playerRequest.playbackContext, a), 
            ...
            Object.defineProperty(Window.prototype.toString, "1c271347300f532347107184abeafda3", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "1c271347300f532347107184abeafda3" due to: ' + e);
        }
    },
