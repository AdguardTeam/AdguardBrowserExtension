...
try {
    var _k = "9c6c2461437a222172a5c932664b31f7";
    if (_b.has(_k)) return;
    _b.add(_k);
...
try {
    var _k = "1fd12adcfadeb42f00feaf2bebc382da";
    if (_b.has(_k)) return;
    _b.add(_k);
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
...
try {
    var _k = "816a72664579ac18edb5f14c3ed582f6";
    if (_b.has(_k)) return;
    _b.add(_k);
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
...
try {
    var _k = "471c2de3f48a70706f985258fee1802e";
    if (_b.has(_k)) return;
    _b.add(_k);
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
...
try {
    var _k = "643b2d3f6e8b7a8f66b636c7e7d25276";
    if (_b.has(_k)) return;
    _b.add(_k);
    trustedClickElement.apply(this, [ {
        name: "trusted-click-element",
