import { documentFilterService } from '../../../../Extension/lib/filter/services/document-filter';
import { backgroundPage } from '../../../../Extension/lib/api/background-page';
...
describe('documentFilterService', () => {
    it('returns url for not trusted url', () => {
        ...
        expect(blockingUrl).toBe('pages/blocking-pages/adBlockedPage.html?url=https%3A%2F%2Fexample.org%2F&rule=%7C%7Cexample.org%5E%24document');
    });
